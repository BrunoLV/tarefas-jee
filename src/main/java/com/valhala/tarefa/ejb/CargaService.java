...
public class CargaService {
	...
	@Auditavel
	@Asynchronous
	public void executarCargaSistema(@Observes @CargaSistema List<Sistema> sistemas) {
	...
	@Auditavel
	@Asynchronous
	public void executarCargaCliente(@Observes @CargaCliente List<Cliente> clientes) {
		Map<String, List<?>> map = new HashMap<String, List<?>>();
	...
	@Auditavel
	@Asynchronous
	public void executarCargaEquipe(@Observes @CargaEquipe List<Equipe> equipes) {
		Map<String, List<?>> map = new HashMap<String, List<?>>();
	...
	@Auditavel
	@Asynchronous
	public void executarCargaColaborador(@Observes @CargaColaborador List<Colaborador> colaboradores) {
		Map<String, List<?>> map = new HashMap<String, List<?>>();
	...
	@Auditavel
	@Asynchronous
	public void executarCargaTarefas(@Observes @CargaTarefa List<Tarefa> tarefas) {
		Map<String, List<?>> map = new HashMap<String, List<?>>();
