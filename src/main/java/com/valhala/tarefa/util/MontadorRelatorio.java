...
public class MontadorRelatorio {
    ...
    private void montarLinhaTarefa(Tarefa tarefa, HSSFSheet sheet, int numeroLinha) {
        ...
        linha.createCell(8).setCellValue(tarefa.getFinalPlanejado() != null ? SDF.format(tarefa.getFinalPlanejado()) : properties.getProperty("arquivo.registro.inexistente"));
        linha.createCell(9).setCellValue(tarefa.getFinalEfetivo() != null ? SDF.format(tarefa.getFinalEfetivo()) : properties.getProperty("arquivo.registro.inexistente"));
        linha.createCell(10).setCellValue(tarefa.getStatus().getNomeExibicao());
        linha.createCell(11).setCellValue(tarefa.getColaborador() != null ? tarefa.getColaborador().getNome() : properties.getProperty("arquivo.registro.inexistente"));
        linha.createCell(12).setCellValue(tarefa.getObservacao() != null && !tarefa.getObservacao().trim().equals("") ? tarefa.getObservacao() : properties.getProperty("arquivo.registro.inexistente"));
