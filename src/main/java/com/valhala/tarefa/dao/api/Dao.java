...
public interface Dao<T> {
    ...
    /**
     * Método definido para execução da inserção de um registro no banco de
     * dados.
     *
    ...
    /**
     * Método definido para execução da edição/atualização de um registro no
     * banco de dados.
     *
    ...
    /**
     * Método definido para execução da remoção de um registrp no banco de
     * dados.
     *
    ...
    /**
     * Método determinado para ação de recuperar um registro do banco de dados
     * utilizando a chave primária como paramentro de consulta.
     *
    ...
    /**
     * Método determinado para ação de recuperar todos os registros do banco de
     * dados.
     *
